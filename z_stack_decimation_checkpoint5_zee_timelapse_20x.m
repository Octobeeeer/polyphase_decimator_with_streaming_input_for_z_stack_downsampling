...
close all;
clear all;
Md = 13; %Downsampling factor in z
Mu = 8; %Upsampling factor in z. The combined factor between downsampling and upsampling will be a new resampling factor of Mu/Mz
L = 19; %Filter length
h = fir1(L,1/Md*0.9);
...
outdir = 'D:\Mikhail\QDIC\Embryos_2016_02_26\20x_data\Checkpoint5_zee_timelapse\Raw_frames';
if (~exist(outdir))
    mkdir(outdir);
end
ff=7:7;
